package com.example.delivery.screen.review
...
import com.example.delivery.screen.review.camera.CameraActivity
import com.example.delivery.screen.review.gallery.GalleryActivity
...
class AddRestaurantReviewActivity : AppCompatActivity() {
    ...
    companion object {
        fun newIntent(
            ...
            val apply = Intent(context, AddRestaurantReviewActivity::class.java).apply {
