package com.example.delivery.screen.main.home.restaurant.detail
...
import com.example.delivery.screen.main.home.restaurant.detail.menu.RestaurantMenuListFragment
import com.example.delivery.screen.main.home.restaurant.detail.review.RestaurantReviewListFragment
            ...
            if (firebaseAuth.currentUser == null){
                alertLoginNeed {
                    lifecycleScope.launch {
                        menuChangeEventBus.changeMenu(MainTavMenu.MY)
                        finish()
                    }
                }
            }else{
